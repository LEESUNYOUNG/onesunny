...
-->
	...
	<body>
		...
		어눌,복부에서 불분명한 불편함, 두통,화상을,혈뇨가 나온다,잠깐 동안 의식을,피로와 쇠약,마음이 안정되지,오심,
				...
				$.ajax({
					...
					success: function (response) {
						...
						for(var i=0;i<myObj2.length;i++){
							str +='<div class="item">'+myObj2[i]['Name']+','+myObj2[i]['DiseaseId']+','+myObj2[i]['Count']+'</div><br/>';
						}
